...
articleView.handleMainNav = function() {
  ...
  $('#main-nav').on('change', function() {
    if ($(this).val()) {
      $('tab').hide();
      $(`tab[data-category="${$(this).val()}"]`).fadein();
...
articleView.setTeasers = function() {
  ...
  // Done, with errors: "DOMException: Failed to execute 'querySelectorAll' on 'Element': '*,:x' is not a valid selector." jQuery error
...
$(document).ready(function() {
  ...
  addEventListener.handleMainNav();
  addEventListener.setTeasers();
})
