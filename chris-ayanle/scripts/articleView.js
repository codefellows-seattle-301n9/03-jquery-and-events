...
articleView.handleAuthorFilter = function() {
  $('#author-filter').on('change', function() {
    ...
    if ($(this).val()) {
      ...
      $('#author-filter option:selected').each(function() {
        $selectedauthors= $(this).text();
      });
      $('article').hide();
      $('[data-author]').each(function(){
        if($(this).attr('data-author') === $selectedauthors) {
